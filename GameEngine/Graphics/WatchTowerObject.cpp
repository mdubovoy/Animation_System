...
WatchTowerObject::WatchTowerObject(const char * const _Name, GeometryModel* const model)
{
    this->setName( _Name );
    this->model = model;
...
void WatchTowerObject::transform(void)
{
...
void WatchTowerObject::setRenderState(TextureMap tex, ShaderMap shade)
{
...
void WatchTowerObject::draw(void)
{
