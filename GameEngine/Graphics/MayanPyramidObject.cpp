...
MayanPyramidObject::MayanPyramidObject(const char * const _Name, GeometryModel* const model)
{
    this->setName( _Name );
    this->model = model;
...
void MayanPyramidObject::transform(void)
{
    // create temp matrices
    Matrix Scale(SCALE, 0.25f, 0.25f, 0.25f);
...
void MayanPyramidObject::setRenderState(TextureMap tex, ShaderMap shade)
{
...
void MayanPyramidObject::draw(void)
{
